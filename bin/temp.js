...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_change_board')) {
        Object.defineProperty(Module['ready'], '_change_board', { configurable: true, get: function() { abort('You are getting _change_board on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_change_board', { configurable: true, set: function() { abort('You are setting _change_board on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_setBoardFromFen')) {
        Object.defineProperty(Module['ready'], '_setBoardFromFen', { configurable: true, get: function() { abort('You are getting _setBoardFromFen on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_setBoardFromFen', { configurable: true, set: function() { abort('You are setting _setBoardFromFen on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _change_board = Module["_change_board"] = createExportWrapper("change_board");

/** @type {function(...*):?} */
var _free = Module["_free"] = createExportWrapper("free");

/** @type {function(...*):?} */
var _setBoardFromFen = Module["_setBoardFromFen"] = createExportWrapper("setBoardFromFen");
